...
/**
 * Сервис для работы с сущностью "Кот"
 *
...
public class CatService {
    ...
    /**
     * Получение полного списка экземпляров сущности "Кот"
     *
     * @return список экземпляров сущности "Кот"
     */
     ...
     *
     * @param cat экземпляр сущности "Кот"
